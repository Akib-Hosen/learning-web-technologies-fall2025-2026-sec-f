        ...
        <fieldset>
            ...
            <form method="post" action="">
                <table>
                    ...
                    <tr>
                        <td><input type="text" name="dd" style="width: 40px;"
                                value="<?php echo isset($_POST['dd']) ? $_POST['dd'] : ''; ?>"> /</td>
                        <td><input type="text" name="mm" style="width: 40px;"
                                value="<?php echo isset($_POST['mm']) ? $_POST['mm'] : ''; ?>"> /</td>
                        <td><input type="text" name="yyyy" style="width: 60px;"
                                value="<?php echo isset($_POST['yyyy']) ? $_POST['yyyy'] : ''; ?>"></td>
                    </tr>
                </table>
                <hr>
